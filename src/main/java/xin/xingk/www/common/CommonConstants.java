...
public class CommonConstants {
    ...
    //密码登录地址
    public final static String PASS_URL="https://passport.aliyundrive.com/newlogin/login.do?appName=aliyun_drive";
    //文件列表
    ...
    //公钥
    public final static String PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDTvO8fAEJPMmHIkyP6jN+hK7rE"
            + "ANn+i7Yn6NJ6RL1dWdzlWRNdZ4qBQ761uNcFbE4ficTh8VJHBiW3tBlEqX8C2m9g"
            + "WkmpPsbrnLry56wrJqNUzmnrJllT0sKeOV1tjBzbaIl4VRqg91IfKQA1+tOBF42g"
            + "vqj55q3OOQIPUTEz+wIDAQAB";
    //文件夹ID
